...
//#define CUSTOM_MACHINE_NAME "°oEND3o°"
...
#define MAX_CHAMBER_POWER 200 // limits duty cycle to chamber heater; 255=full current
  ...
  #define MIN_CHAMBER_POWER 50
  //#define PID_CHAMBER_DEBUG // Sends debug data to the serial port.

  // Lasko "MyHeat Personal Heater" (200w) modified with a Fotek SSR-10DA to control only the heating element
  // and placed inside the small Creality printer enclosure tent.
  //
  #define DEFAULT_chamberKp 5
  #define DEFAULT_chamberKi 2
  #define DEFAULT_chamberKd 3
 ...
 */
//#define PRINTCOUNTER    //To prevent step loss, motion will pause for PRINTCOUNTER auto-save.
